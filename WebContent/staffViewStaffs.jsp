		...
		<div class="card">
					...
					<div class="collapse navbar-collapse" id="navbarTogglerDemo03">
						<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
							<li class="nav-item active"><a class="nav-link"
								href="staffWelcome.jsp">Home <span class="sr-only">(current)</span>
							</a></li>
			...
			<div class="card-body">
				...
				<div class="row">
						...
						<ul class="list-group">
							<li class="list-group-item"><a
								class="list-group-item-action d-flex
                                        ...
                                        align-items-center"
								href="staffWelcomw.jsp"> <i class="fa fa-video-camera" aria-hidden="true"></i>
									Class
							</a></li>
							<li class="list-group-item"><a
								class="list-group-item-action d-flex
							...
							<li class="list-group-item"><a style="color: #00cc00;"
								class="list-group-item-action d-flex
                                        justify-content-between
                                        align-items-center"
								href="staffViewStaffs.jsp"> <i class="fa fa-users"
							...
							<li class="list-group-item"><a
								class="list-group-item-action d-flex
                                        justify-content-between
                                        align-items-center"
								href="staffViewStudents.jsp"> <i class="fa fa-id-card-o"
					...
					<div class="window" style="width: 40rem; padding-left: 20px;">
						<!--  -->
						<div
