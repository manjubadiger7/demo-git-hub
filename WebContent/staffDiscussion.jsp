					...
					<div class="window" style="height: 10rem; width: 40rem;">
						<div
							...
							<div class="comment">
								...
								<div class="writeComment" style="margin-left:10px;">
							<div class="row">
								<form class="form-inline my-2 my-lg-0" action="postComment"
									...
									<button
										class="btn btn-outline-success my-2
                                    my-sm-0"
										type="submit">Send replay <i class="fa fa-reply" aria-hidden="true"></i></button>
								</form>
							</div>
