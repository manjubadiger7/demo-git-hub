...
<link rel="stylesheet" href="css/studentWelcome.css">
			...
			<div class="card-body">
				...
				<div class="row">
						...
						<ul class="list-group">
							...
							<li class="list-group-item"><a
								class="list-group-item-action d-flex
                                        justify-content-between
                                        align-items-center"
								href="studentViewStaff.jsp"> <i class="fa fa-users" aria-hidden="true"></i>
									View Staffs
							</a></li>
							...
							<li class="list-group-item"><a
								class="list-group-item-action d-flex
                                        justify-content-between
                                        align-items-center"
								href="studentViewStudents.jsp"> <i class="fa fa-id-card-o" aria-hidden="true"></i>
									View Students
							</a></li>
							<li class="list-group-item"><a
								class="list-group-item-action d-flex
					...
					<div class="window" style="width: 40rem; padding-left: 2rem">
						<div
							style="display: block; position: relative; height: 22rem; overflow: auto;"
